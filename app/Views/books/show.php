...
<div class="card">
  <div class="card-body">
    ...
    <h5 class="card-title fw-semibold mb-4">Detail Baju</h5>
    <div class="row">
      ...
      <div class="col-12 col-lg-8 d-flex flex-wrap">
        <div class="w-100 mb-2">
          ...
          <h5>Ukuran: <?= $book['author']; ?></h5>
          <h5>Kode Baju: <?= $book['publisher']; ?></h5>
          <h5>Kategori: <?= $book['category']; ?></h5>
          <h5>Rak & Kontainer: <?= $book['rack']; ?>, Tingkat <?= $book['floor']; ?></h5>
        </div>
      </div>
    </div>
  </div>
