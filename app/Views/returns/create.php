    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 mb-3">
          <div class="row">
            <div class="col-12 mb-3">
              <label for="book_title" class="form-label">Jenis Baju</label>
              <input type="text" class="form-control" id="book_title" name="book_title" value="<?= "{$loan['title']}"; ?>" disabled>
            </div>
            <div class="col-12 mb-3">
              <label for="book_author" class="form-label">Ukuran & Kode Baju</label>
