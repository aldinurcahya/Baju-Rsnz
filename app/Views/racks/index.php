    ...
    <div class="overflow-x-scroll">
      <table class="table table-hover table-striped">
        <thead class="table-light">
          <tr>
            <th scope="col">#</th>
            <th scope="col">Rak dan Kontainer</th>
            <th scope="col" class="text-center">Tingkat</th>
            <th scope="col" class="text-center">Jumlah Baju</th>
              ...
              <td>
                <div class="d-flex justify-content-center gap-2">
                  ...
                  <form action="<?= base_url("admin/racks/{$rack['id']}"); ?>" method="post">
                    ...
                    <button type="submit" class="btn btn-danger" onclick="return confirm('Apa anda yakin ingin menghapus data ini?');">
