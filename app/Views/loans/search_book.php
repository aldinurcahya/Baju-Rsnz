  ...
  <div class="card-body">
    <div class="row">
      <div class="col-12 col-lg-6">
        <h5 class="card-title fw-semibold mb-4">Pilih Baju</h5>
        <div class="mb-4">
          <label for="search" class="form-label">Cari Jenis Baju</label>
          <input type="text" class="form-control" id="search" name="search" placeholder="Cari Baju">
    ...
    <div class="my-4">
      <h5 class="card-title fw-semibold mb-4">Baju dipilih</h5>
      <ul id="bookList" class="d-flex d-flex flex-wrap gap-2">
        <li id="none">--Silahkan cari dan pilih Baju terlebih dahulu--</li>
      </ul>
    ...
    <div class="row">
      <div class="col-12">
        <div id="bookResult">
          <p class="text-center mt-4">Data Baju muncul disini</p>
        </div>
      </div>
    </div>
  </div>
  ...
  function removeBook(slug) {
    ...
    if (bookElement !== null && bookInputElement !== null) {
      ...
      if (bookSelection.size <= 0) {
        bookListElement.innerHTML += `<li id="none">--Silahkan cari dan pilih baju terlebih dahulu--</li>`;
