...
<div class="card">
  <div class="card-body">
    <h5 class="card-title fw-semibold mb-4">Peminjaman Baju Berhasil</h5>
            ...
            <tr>
              ...
              <td>
                <a href="<?= base_url("admin/books/{$loan['slug']}"); ?>">
                  <p class="text-primary-emphasis text-decoration-underline"><b><?= "{$loan['title']}"; ?></b></p>
              ...
              <td class="text-center">
                <div class="d-flex justify-content-center gap-2">
                  ...
                  <form action="<?= base_url("admin/loans/{$loan['uid']}"); ?>" method="post">
                    ...
                    <button type="submit" class="btn btn-danger mb-2" onclick="return confirm('Anda yakin ingin membatalkan?');">
                      <i class="ti ti-x"></i>
                      Batalkan
                    </button>
                  </form>
