...
<form action="<?= base_url('admin/loans'); ?>" method="post">
  ...
  <div class="card">
    <div class="card-body">
      <h5 class="card-title fw-semibold mb-4">Form Peminjaman Baju</h5>
      <div class="row">
                ...
                <div class="row">
                  <div class="col-5">
                    <div class="d-flex align-items-start" style="margin-left: 100px;">
                      <div>
                        <p style="overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical;"><b><?= "{$book['title']}"; ?></b></p>
                        <p>Ukuran: <?= $book['author']; ?></p>
                        <p>Kode Baju: <?= $book['publisher']; ?></p>
                      </div>
                    </div>
                  </div>
                  <div class="col-2">
