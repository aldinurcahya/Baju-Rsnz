    ...
    <form action="<?= base_url('admin/members'); ?>" method="post">
      ...
      <div class="row mt-3">
        <div class="col-12 col-md-6 mb-3">
          ...
          <input type="text" class="form-control <?php if ($validation->hasError('first_name')) : ?>is-invalid<?php endif ?>" id="first_name" name="first_name" value="<?= $oldInput['first_name'] ?? ''; ?>" placeholder="Reso" required>
        ...
        <div class="col-12 col-md-6 mb-3">
          ...
          <input type="text" class="form-control <?php if ($validation->hasError('last_name')) : ?>is-invalid<?php endif ?>" id="last_name" name="last_name" value="<?= $oldInput['last_name'] ?? ''; ?>" placeholder="Nanz" required>
          <div class="invalid-feedback">
      ...
      <div class="row">
        <div class="col-12 col-md-6 mb-3">
          ...
          <input type="email" class="form-control <?php if ($validation->hasError('email')) : ?>is-invalid<?php endif ?>" id="email" name="email" value="<?= $oldInput['email'] ?? ''; ?>" placeholder="reso@gmail.com" required>
          <div class="invalid-feedback">
        ...
        <div class="col-12 col-md-6 mb-3">
          ...
          <input type="tel" class="form-control <?php if ($validation->hasError('phone')) : ?>is-invalid<?php endif ?>" id="phone" name="phone" value="<?= $oldInput['phone'] ?? ''; ?>" placeholder="+62812345" required>
          <div class="invalid-feedback">
